...
const frag = /* glsl */ `
    ...
    const vec3 baseColor1 = vec3(0.745098, 0.400000, 0.905882); // акцентный фиолетовый
    const vec3 baseColor2 = vec3(0.941176, 0.494118, 0.403922); // коралловый
    const vec3 baseColor3 = vec3(0.000000, 0.458824, 0.650980); // глубокий синевато-бирюзовый
...
const setupAnimation = () => {
  ...
  const update = (t: number) => {
    ...
    if (props.rotateOnHover && effectiveHover > 0.5) {
      currentRot += dt * props.rotationSpeed
    }
